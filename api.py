...
class PetFriends:
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str,
                      pet_photo: str) -> json:
        """Метод отправляет запрос на сервер о добавлении фото питомца по указанному ID
        и возвращает статус запроса result в формате JSON с обновленными данными питомца"""
